...
smoker.remove(<item:minecraft:green_dye>);
smoker.remove(<item:minecraft:dried_kelp>);
blastFurnace.remove(<item:minecraft:green_dye>);
blastFurnace.remove(<item:minecraft:dried_kelp>);

//#--> Adding Crafts...

//============================== RECIPES BALANCING ========================================//

smoker.addJsonRecipe("green_dye0", {
    ingredient: <item:minecraft:cactus>,
    result: <item:minecraft:green_dye>.registryName,
    experience: 0.0 as float,
    cookingtime:100
});
smoker.addJsonRecipe("dried_kelp0", {
    ingredient: <item:minecraft:kelp>,
    result: <item:minecraft:dried_kelp>.registryName,
    experience: 0.0 as float,
    cookingtime:50
});
furnace.addJsonRecipe("green_dye1", {
    ingredient: <item:minecraft:cactus>,
    result: <item:minecraft:green_dye>.registryName,
    experience: 0.0 as float,
    cookingtime:160
});
furnace.addJsonRecipe("dried_kelp1", {
    ingredient: <item:minecraft:kelp>,
    result: <item:minecraft:dried_kelp>.registryName,
    experience: 0.0 as float,
    cookingtime:80
...
craftingTable.addShapeless("cobblestone_to_deepslate0", <item:minecraft:cobblestone> * 1, [<item:minecraft:cobbled_deepslate>]);
craftingTable.addShapeless("deepslate_to_cobblestone0", <item:minecraft:cobbled_deepslate> * 1, [<item:minecraft:cobblestone>]);
...
craftingTable.remove(<item:snifferplus:stone_pine_pressure_plate>);
craftingTable.remove(<item:snifferplus:stone_pine_button>);
craftingTable.remove(<item:snifferplus:stone_pine_sign>);
craftingTable.remove(<item:snifferplus:stone_pine_hanging_sign>);
craftingTable.remove(<item:snifferplus:stone_pine_boat>);
craftingTable.remove(<item:snifferplus:stone_pine_chest_boat>);
...
craftingTable.remove(<item:tide:red_fishing_bobber>);
craftingTable.remove(<item:tide:orange_fishing_bobber>);
craftingTable.remove(<item:tide:yellow_fishing_bobber>);
craftingTable.remove(<item:tide:lime_fishing_bobber>);
craftingTable.remove(<item:tide:green_fishing_bobber>);
craftingTable.remove(<item:tide:cyan_fishing_bobber>);
craftingTable.remove(<item:tide:light_blue_fishing_bobber>);
craftingTable.remove(<item:tide:blue_fishing_bobber>);
craftingTable.remove(<item:tide:purple_fishing_bobber>);
craftingTable.remove(<item:tide:magenta_fishing_bobber>);
craftingTable.remove(<item:tide:pink_fishing_bobber>);
craftingTable.remove(<item:tide:white_fishing_bobber>);
craftingTable.remove(<item:tide:light_gray_fishing_bobber>);
craftingTable.remove(<item:tide:gray_fishing_bobber>);
craftingTable.remove(<item:tide:black_fishing_bobber>);
craftingTable.remove(<item:tide:brown_fishing_bobber>);
craftingTable.remove(<item:tide:fishing_journal>);
craftingTable.remove(<item:tide:surface_loot_crate>);
craftingTable.remove(<item:tide:bait>);
craftingTable.remove(<item:tide:lucky_bait>);
craftingTable.remove(<item:tide:magnetic_bait>);
craftingTable.remove(<item:tide:lavaproof_fishing_hook>);
craftingTable.remove(<item:tide:braided_line>);
craftingTable.remove(<item:tide:fortune_line>);

//#--> Adding Crafts...

craftingTable.addShaped("bait0", <item:tide:bait> * 16, [
    [<tag:items:forge:seeds>, <item:minecraft:bone_meal>, <tag:items:forge:seeds>],
    [<item:minecraft:bone_meal>, <item:tide:fish_slice>, <item:minecraft:bone_meal>],
    [<tag:items:forge:seeds>, <item:minecraft:bone_meal>, <tag:items:forge:seeds>]
]);
craftingTable.addShaped("lucky_bait0", <item:tide:lucky_bait> * 20, [
    [<item:minecraft:air>, <item:tide:bait>, <item:minecraft:air>],
    [<item:tide:bait>, <item:minecraft:rabbit_foot>, <item:tide:bait>],
    [<item:minecraft:air>, <item:tide:bait>, <item:minecraft:air>]
]);
craftingTable.addShaped("magnetic_bait0", <item:tide:magnetic_bait> * 8, [
    [<item:minecraft:redstone_block>, <item:tide:bait>, <item:minecraft:lapis_block>],
    [<item:tide:bait>, <item:minecraft:prismarine_crystals>, <item:tide:bait>],
    [<item:minecraft:lapis_block>, <item:tide:bait>, <item:minecraft:redstone_block>]
]);
craftingTable.addShaped("lavaproof_fishing_hook0", <item:tide:lavaproof_fishing_hook> * 1, [
...
craftingTable.addShaped("braided_line0", <item:tide:braided_line> * 1, [
    [<item:minecraft:string>, <item:minecraft:slime_ball>, <item:minecraft:string>],
    [<item:minecraft:string>, <item:tide:fishing_line>, <item:minecraft:string>],
    [<item:minecraft:string>, <item:minecraft:slime_ball>, <item:minecraft:string>]
]);
craftingTable.addShaped("fortune_line0", <item:tide:fortune_line> * 1, [
    [<item:minecraft:air>, <item:minecraft:gold_block>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:tide:fishing_line>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:gold_block>, <item:minecraft:air>]
]);
craftingTable.addShapeless("fish_slice0", <item:tide:fish_slice> * 2, [<tag:items:tide:journal_fish>]);
...
craftingTable.remove(<item:stardew_fishing:cork_bobber>);
craftingTable.remove(<item:stardew_fishing:treasure_bobber>);

//#--> Adding Crafts...

craftingTable.addShaped("cork_bobber0", <item:stardew_fishing:cork_bobber> * 1, [
    [<tag:items:forge:stripped_logs>, <tag:items:forge:stripped_logs>, <tag:items:forge:stripped_logs>],
    [<item:minecraft:barrel>, <item:minecraft:barrel>, <item:minecraft:barrel>],
    [<tag:items:forge:stripped_logs>, <tag:items:forge:stripped_logs>, <tag:items:forge:stripped_logs>]
]);
craftingTable.addShaped("treasure_bobber0", <item:stardew_fishing:treasure_bobber> * 1, [
    [<item:minecraft:air>, <item:minecraft:redstone_block>, <item:minecraft:air>],
    [<item:minecraft:gold_block>, <item:minecraft:iron_ingot>, <item:minecraft:gold_block>],
    [<item:minecraft:air>, <item:minecraft:tripwire_hook>, <item:minecraft:air>]
]);
...
craftingTable.addShaped("undead_eye0", <item:endrem:undead_eye> * 1, [
    [<item:minecraft:blaze_rod>, <item:minecraft:phantom_membrane>, <item:minecraft:blaze_rod>],
    [<item:minecraft:bone>, <item:minecraft:blaze_rod>, <item:minecraft:rotten_flesh>],
    [<item:minecraft:blaze_rod>, <item:minecraft:phantom_membrane>, <item:minecraft:blaze_rod>]
]);
...
//#--> Remove All Crafts...
craftingTable.removeByModid("spartanweaponry");
blastFurnace.removeByModid("spartanweaponry");
campfire.removeByModid("spartanweaponry");
furnace.removeByModid("spartanweaponry");
smithing.removeByModid("spartanweaponry");
smoker.removeByModid("spartanweaponry");
stoneCutter.removeByModid("spartanweaponry");

//#--> Adding Crafts...

craftingTable.addShaped("wood_dagger0", <item:spartanweaponry:wooden_dagger> * 1, [
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>],
    [<item:minecraft:air>, <tag:items:minecraft:planks>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:stick>, <item:minecraft:air>]
]);
craftingTable.addShaped("stone_dagger0", <item:spartanweaponry:stone_dagger> * 1, [
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:cobblestone>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:stick>, <item:minecraft:air>]
]);
craftingTable.addShaped("iron_dagger0", <item:spartanweaponry:iron_dagger> * 1, [
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:iron_ingot>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:stick>, <item:minecraft:air>]
]);
craftingTable.addShaped("gold_dagger0", <item:spartanweaponry:golden_dagger> * 1, [
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:gold_ingot>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:stick>, <item:minecraft:air>]
]);
craftingTable.addShaped("diamond_dagger0", <item:spartanweaponry:diamond_dagger> * 1, [
    [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:diamond>, <item:minecraft:air>],
    [<item:minecraft:air>, <item:minecraft:stick>, <item:minecraft:air>]
]);
craftingTable.addShaped("wood_glaive0", <item:spartanweaponry:wooden_glaive> * 1, [
...
craftingTable.addShaped("stone_glaive0", <item:spartanweaponry:stone_glaive> * 1, [
    [<item:minecraft:air>, <item:minecraft:cobblestone>, <item:minecraft:cobblestone>],
    [<item:minecraft:air>, <item:minecraft:stick>, <item:minecraft:air>],
    [<item:minecraft:stick>, <item:minecraft:air>, <item:minecraft:air>]
]);
craftingTable.addShaped("iron_glaive0", <item:spartanweaponry:iron_glaive> * 1, [
    [<item:minecraft:air>, <item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>],
    [<item:minecraft:air>, <item:minecraft:stick>, <item:minecraft:air>],
    [<item:minecraft:stick>, <item:minecraft:air>, <item:minecraft:air>]
]);
craftingTable.addShaped("gold_glaive0", <item:spartanweaponry:golden_glaive> * 1, [
    [<item:minecraft:air>, <item:minecraft:gold_ingot>, <item:minecraft:gold_ingot>],
    [<item:minecraft:air>, <item:minecraft:stick>, <item:minecraft:air>],
    [<item:minecraft:stick>, <item:minecraft:air>, <item:minecraft:air>]
]);
craftingTable.addShaped("diamond_glaive0", <item:spartanweaponry:diamond_glaive> * 1, [
...
//#--> Remove All Crafts...
craftingTable.removeByModid("v_turrets");

//#--> Adding Crafts...

craftingTable.addShaped("basic_core0", <item:v_turrets:basic_turret_core> * 1, [
    [<item:minecraft:copper_ingot>, <item:minecraft:copper_block>, <item:minecraft:copper_ingot>],
    [<item:minecraft:cobblestone>, <item:minecraft:diamond>, <item:minecraft:cobblestone>],
    [<item:minecraft:cobblestone>, <item:prettypipes:blank_module>, <item:minecraft:cobblestone>]
]);
craftingTable.addShaped("seed_core0", <item:v_turrets:seed_turret_core> * 1, [
...
craftingTable.addShaped("tbasic_1_0", <item:v_turrets:basic_turret_t1> * 1, [
    [<item:minecraft:copper_ingot>, <item:minecraft:copper_ingot>, <item:minecraft:copper_ingot>],
    [<item:minecraft:iron_ingot>, <item:v_turrets:basic_turret_core>, <item:minecraft:dispenser>],
    [<item:minecraft:iron_ingot>, <item:minecraft:iron_block>, <item:minecraft:iron_ingot>]
]);
craftingTable.addShaped("tbasic_2_0", <item:v_turrets:basic_turret_t2> * 1, [
    [<item:minecraft:black_stained_glass>, <item:minecraft:black_stained_glass>, <item:minecraft:black_stained_glass>],
    [<item:minecraft:diamond>, <item:v_turrets:basic_turret_core>, <item:minecraft:dispenser>],
    [<item:prettypipes:redstone_module>, <item:minecraft:iron_block>, <item:minecraft:iron_ingot>]
]);
craftingTable.addShaped("tseed_1_0", <item:v_turrets:seed_turret_t1> * 1, [
    [<item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>],
    [<item:minecraft:iron_ingot>, <item:v_turrets:seed_turret_core>, <item:minecraft:dispenser>],
    [<item:minecraft:iron_ingot>, <item:minecraft:iron_block>, <item:minecraft:iron_ingot>]
]);
craftingTable.addShaped("tseed_2_0", <item:v_turrets:seed_turret_t2> * 1, [
    [<item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>, <item:minecraft:copper_ingot>],
    [<item:prettypipes:redstone_module>, <item:v_turrets:seed_turret_core>, <item:minecraft:dispenser>],
...
//#--> Remove All Crafts...
craftingTable.removeByModid("morebuckets");

//#--> Adding Crafts...

craftingTable.addShaped("gold_bucket0", <item:morebuckets:golden_bucket> * 1, [
